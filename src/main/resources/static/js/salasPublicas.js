...
function salasPublicas(datos){
	...
	for(numero in datos){
			s=s+'<tr class="jugadores"><th>'+ datos[numero].nombre +'</th><th>' + datos[numero].jugadores.length +'/6</th><th>'+ datos[numero].valorsala +'</th><th><label id="'+ datos[numero].nombre +'" class="link">Unirse a Sala</label></th></tr>';
