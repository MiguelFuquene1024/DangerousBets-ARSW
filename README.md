# DangerousBets-ARSW
 ...
 En este proyecto se desarrollara un plataforma de apuestas(POKER) online en la que los usuarios podrán interactuar entre ellos, los usuarios podran realizar apuestas, unirse a salas y jugar.
 
 ## Casos de Usuario:
 
  * Como usuario quiero acceder a salas para poder jugar con otros usuarios.
  * Como usuario quiero apostar para poder ganar mas monedas.
